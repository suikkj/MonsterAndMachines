...
// Sculk tendril blocks that deal damage (hashmap for O(1) lookup)
var TENDRIL_BLOCKS = {
    'deeperdarker:sculk_tendrils': true
}
...
PlayerEvents.tick(function (event) {
    ...
    var inTendril = !!(TENDRIL_BLOCKS[blockAt.id] || TENDRIL_BLOCKS[blockBelow.id])
    ...
    if (inTendril) {
        ...
        // Deal damage using direct API (PERFORMANCE: replaces runCommandSilent)
        player.attack(TENDRIL_DAMAGE)
    }
})
