...
var EXPEDITION_LORE = {
    group1: {
        ...
        author: 'Sunny Dantas',
        pages: [
            'Dia 1 - Finalmente saimos do Refugio Cigarra apos 2.740 anos. A superficie e... como foi descrito pelos cientistas da T.U.R. Ainda sim, é difícil acreditar que isso é o que restou. Em livros e fotografias, eu e o Nimbus sempre víamos como o mundo era antigamente.',
    ...
    group2: {
        ...
        pages: [
            ...
            'Durante as investigações, percebi índices de algumas ruínas e marcas que levam a crer que a localização do Refúgio Cigarra se localiza a poucos quilômetros da capital.',
            ...
            'Foram coletadas amostras do VALID-71 de areas diferentes. Das áreas completamente consumidas até as que se mantiveram de pé, mesmo que em ruínas. Enviaremos isso ao Refúgio Cigarra para que enviem a cientista do Refúgio Cobra.',
    ...
    group3: {
        title: 'Galera Expedicionaria 3',
        author: 'Carlito',
        pages: [
            'Ja que o pessoal do Refugio vai ler essas anotacoes, queria enfatizar A MISERIA DE SUPRIMENTO.'
        ]
    }
}
